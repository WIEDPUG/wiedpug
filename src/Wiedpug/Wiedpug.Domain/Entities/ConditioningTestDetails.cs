...
namespace Wiedpug.Domain.Entities
{
    public class ConditioningTestDetails
    {
        ...
        public decimal? MassOfGlobalSample { get; set; }

        [RegularExpression(RegexPattern.DECIMAL_TWO_DIGITS)]
        public decimal? SumOfODMasses { get; set; }
        ...
        [Required]
        [RegularExpression(RegexPattern.DECIMAL_TWO_DIGITS)]
        public required decimal MoistureContent { get; set; }

        [Required]
        [RegularExpression(RegexPattern.DECIMAL_TWO_DIGITS)]
        public required decimal Regain { get; set; }

        [Required]
        [RegularExpression(RegexPattern.DECIMAL_SIX_DIGITS)]
        public required decimal NetWeightODOfConsignment { get; set; }
        ...
        [Required]
        [RegularExpression(RegexPattern.DECIMAL_SIX_DIGITS)]
        public required decimal OfficialRegain { get; set; }
