...
public static class LotInvoicesEndpoints
{
    public static void MapLotInvoicesEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        //group.MapPost("/data",
        //[SwaggerRequestExample(typeof(GetLotInvoicesRequest), typeof(GetLotInvoicesRequestExample))]
        //[SwaggerResponseExample(StatusCodes.Status200OK, typeof(GetLotInvoices200Example))]
       // [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(CommonResponse400ArrayRequestPayloadExample))]
        //[SwaggerResponseExample(StatusCodes.Status401Unauthorized, typeof(CommonResponse401Example))]
        //[SwaggerResponseExample(StatusCodes.Status403Forbidden, typeof(CommonResponse403NoReadPermissionExample))]
