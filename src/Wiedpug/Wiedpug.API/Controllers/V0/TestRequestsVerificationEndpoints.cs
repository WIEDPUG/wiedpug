...
public static class TestRequestsVerificationEndpoints
{
    public static void MapTestRequestsVerificationEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/data",
        [SwaggerRequestExample(typeof(RequestForTestRequestsVerification), typeof(RequestForTestRequestsVerificationExample))]
        ...
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(CommonResponse500Example))]
        ([FromBody] RequestForTestRequestsVerification model) =>
        {
