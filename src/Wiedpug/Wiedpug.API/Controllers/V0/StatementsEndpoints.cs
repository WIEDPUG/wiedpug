...
public static class StatementsEndpoints
{
    public static void MapStatementsEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/",
        [SwaggerRequestExample(typeof(List<Statements>), typeof(CreateStatementsRequestExample))]
        ...
        ([FromBody] List<Statements> model) =>
            {
        ...
        group.MapPost("/data",
        [SwaggerRequestExample(typeof(List<RequestForData>), typeof(RequestForStatementsRequestExample))]
        ...
        .Produces<List<ApiResult<List<Statements>>>>(StatusCodes.Status200OK, contentType: "application/json")
