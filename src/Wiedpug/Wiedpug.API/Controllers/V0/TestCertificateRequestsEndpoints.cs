...
public static class TestCertificateRequestsEndpoints
{
    public static void MapTestCertificateRequestsEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/",
        [SwaggerRequestExample(typeof(List<TestCertificateRequests>), typeof(TestCertificateRequestsRequestExample))]
        ...
        group.MapPost("/data",
            [SwaggerRequestExample(typeof(List<RequestForData>), typeof(RequestForDataForTestCertificatesRequestsExample))]
        ...
        .Produces<List<ApiResult<List<TestCertificateRequests>>>>(StatusCodes.Status200OK, contentType: "application/json")
