...
public static class PaymentConfirmationEndpoints
{
    public static void MapPaymentConfirmationEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/data",
        [SwaggerRequestExample(typeof(RequestForPaymentConfirmation), typeof(RequestForPaymentConfirmationRequestExample))]
        ...
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(CommonResponse500Example))]
        ([FromBody] RequestForPaymentConfirmation model) =>
        {
