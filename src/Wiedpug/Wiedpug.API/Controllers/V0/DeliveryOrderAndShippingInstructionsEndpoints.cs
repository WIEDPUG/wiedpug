...
public static class DeliveryOrderAndShippingInstructionsEndpoints
{
    public static void MapDeliveryOrderAndShippingInstructionsEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/data",
        [SwaggerRequestExample(typeof(RequestForDeliveryOrderAndShippingInstructions), typeof(RequestForDeliveryOrdersAndShippingInstructionsExample))]
        ...
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(CommonResponse500Example))]
        ([FromBody] RequestForDeliveryOrderAndShippingInstructions model) =>
        {
