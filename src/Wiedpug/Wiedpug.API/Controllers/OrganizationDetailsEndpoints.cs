...
{
    public static void MapOrganizationDetailsApiResultEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(OrganizationDetails200Example))]
