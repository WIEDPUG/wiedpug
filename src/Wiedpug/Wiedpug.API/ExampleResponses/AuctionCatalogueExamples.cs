...
,                               },
    ...
    public class AuctionCatalogueUpdatesRequestExample : IExamplesProvider<AuctionCatalogue>
    {
        public AuctionCatalogue GetExamples()
        {
            return new AuctionCatalogue
...
,                               },
    ...
    public class RequestForDataAuctionCatalogueRequestExample : IExamplesProvider<RequestForDataForAuctionCatalogue>
    {
        public RequestForDataForAuctionCatalogue GetExamples()
        {
            return new RequestForDataForAuctionCatalogue()
            {
    ...
    public class RequestForStatusAuctionCatalogueRequestExample : IExamplesProvider<RequestForStatusForAuctionCatalogue>
    {
        public RequestForStatusForAuctionCatalogue GetExamples()
        {
            return new RequestForStatusForAuctionCatalogue()
            {
                TransmissionTypeRequested = Domain.Enums.TransmissionTypeForAuctionCatalogue.AuctionCatalogues,
                SaleIdentity = new Domain.Entities.SaleIdentity
                {
